...
- [[[dddCrew, DddCrew]]] Ddd-Crew. GitHub - ddd-crew/core-domain-charts: A tool for collaboratively finding your core domains - strategic business differentiators. GitHub. Retrieved October 18, 2025, from https://github.com/ddd-crew/core-domain-charts/tree/master
...
- [[[hiredThought, HiredThought]]] Hired Thought. (n.d.). Learn Wardley Mapping. Retrieved October 18, 2025, from https://learnwardleymapping.com/
...
- [[[opdyke,Opdyke]]] William Opdyke: Refactoring Object-Oriented Framdworks. 1992. Groundwork for the notion of _refactoring_. http://www.laputan.org/pub/papers/opdyke-thesis.pdf.
...
- [[[openGroup, OpenGroup]]] The Open Group. (n.d.). TOGAF Architecture Principles. https://pubs.opengroup.org/togaf-standard/adm-techniques/chap02.html
