...
- [[[dddCrew, Domain-Driven Design Crew]]] Domain-Driven Design Crew. GitHub - ddd-crew/core-domain-charts: A tool for collaboratively finding your core domains - strategic business differentiators. GitHub. Retrieved October 18, 2025, from https://github.com/ddd-crew/core-domain-charts/
...
- [[[geeks, GeeksforGeeks]]] GeeksforGeeks. (2025, August 21). The ultimate guide to the North Star product Framework. GeeksforGeeks. https://www.geeksforgeeks.org/marketing/the-ultimate-guide-to-the-north-star-product-framework/

**H**

- [[[hiredThought, Hired Thought]]] Hired Thought. (n.d.). Learn Wardley Mapping. Retrieved October 18, 2025, from https://learnwardleymapping.com/
...
- [[[kleppmann,Kleppmann]]] Martin Kleppmann: Designing Data-Intensive Applications - The Big Ideas Behind Reliable, Scalable and Maintainable Systems. O'Reilly, 2017.
...
- [[[kruchtenTechDebt,Kruchten+2019]]] Kruchten, Philippe, Robert Nord, Ipak Ozkaya: Managing Technical Debt. Addison-Wesley 2019.
...
- [[[opdyke,Opdyke]]] William Opdyke: Refactoring Object-Oriented Frameworks. 1992. Groundwork for the notion of _refactoring_. http://www.laputan.org/pub/papers/opdyke-thesis.pdf.
...
- [[[refactoring, Refactoring-Catalog]]] The Refactoring Catalog (lead by Martin Fowler):online https://refactoring.com/catalog/
