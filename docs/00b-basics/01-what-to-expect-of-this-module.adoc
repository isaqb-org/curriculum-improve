...
Zusätzlich zeigt der IMPROVE-Lehrplan typische Ansätze für Verbesserungen auf, beispielsweise Restrukturierungen und Refactoring, Verbesserungen der Analysierbarkeit, Prozessverbesserung, Verbesserung der technischen Infrastruktur, Verbesserung von Qualitätseigenschaften, etc.
...
You learn to apply various analysis methods to identify problems and risks of various categories, and document these findings appropriately. 
...
It introduces a few economic metrics (ROI, CAPEX/OPEX, break-even) and estimation techniques to assess the _severity_ of problems and risks. 
...
Covers how to plan and communicate sustainable improvement strategies. 
