...
* Compliance with established document structures (e.g., templates like arc42)
* Targeted reduction of documentation volume through abstraction (e.g., via principles and guidelines), standardization (e.g., following framework conventions) and/or focussing on essential topics that cannot be otherwise communicated
* Top-down communication, separation of structural (specific) and conceptual (overarching) contents, modularization of documentation
