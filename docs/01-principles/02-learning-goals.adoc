...
** Ständige Scope-Änderungen unter Zeit-/Kostendruck (häufig wechselnde Anforderungen, Prioritäten oder Abnahmekriterien), führen zu Ad-hoc-Arbeit, zur Erosion der konzeptuellen Integrität und zur Akkumulation von Altlasten/technischer Schuld.
...
They should know that continual scope churn under pressure creates “legacy” debt.
