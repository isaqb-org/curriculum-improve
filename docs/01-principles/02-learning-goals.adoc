...
* Konzeptionelle Schwächen, beispielsweise Verletzung konzeptioneller Integrität, übermäßige Redundanz
...
** Ständige Scope-Änderungen unter Zeit-/Kostendruck (häufig wechselnde Anforderungen, Prioritäten oder Abnahmekriterien) als Ursache von Ad-hoc-Arbeit, Erosion der konzeptuellen Integrität und Akkumulation von Altlasten/technischer Schuld

Softwarearchitekt:innen sollten wissen, dass ständige Scope-Änderungen unter Druck zu Altlasten und technischer Schuld führen.

Siehe <<kruchtenTechDebt>>, <<starke-debt>>, <<ernst-techDebt>>.
...
** high complexity,
** low cohesion,
** craftsmanship weaknesses in programming, such as non-idiomatic use of programming languages or tools
...
They should know that continual scope churn under pressure creates legacy code and technical debt.
