...
* die durch Probleme oder Risiken verursachten (potentiellen) Schäden (_Schmerzen_) quantitativ einschätzen,
* bei der Schätzung Annahmen und Einflussfaktoren offenlegen und plausible Bereiche für diese Faktoren angeben, um die Schätzungen transparent und reproduzierbar zu halten.
