...
** Größere Neugestaltung grundlegender Strukturen, Konzepte oder Muster, um die konzeptionelle Integrität wiederherzustellen oder an neue Anforderungen anzupassen.
...
** Entwicklung eines neuen Systems oder Subsystems, wenn das bestehende System aufgrund massiver Probleme, konzeptionellen Verfalls oder signifikant geänderter Anforderungen inkrementelle Verbesserungen unwirtschaftlich macht.
...
* Für Technologien/Programmiersprachen typische Refactorings (verhaltenserhaltende Vereinfachungsmaßnahmen im Quellcode) kennen und beurteilen können.
...
* können deren Effekte (Wirkungen und Nebenwirkungen), ggf. unter Zuhilfenahme entsprechender Werkzeuge, nachvollziehen.
...
* Gezielte Reduktion des Dokumentationsumfangs durch Abstraktion oder inhaltliche Fokussierung
