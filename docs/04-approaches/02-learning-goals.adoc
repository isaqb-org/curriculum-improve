...
* automatisierte Tests (Unit-, Integrations-, Akzeptanz-, Regressionstests) als Mittel zur Früherkennung von Fehlern nach Änderungen konzipieren und umsetzen können, einschließlich KI-gestützter Testgenerierung (inkl. deren Grenzen),
...
** Everything-as-Code-Techniken (z.B. für Dokumentation, Diagramme, Pipelines, Infrastruktur)
** Codetransformationswerkzeuge für umfangreiche Refactorings, bei Bedarf unterstützt durch generative Ansätze
...
* be able to design and implement automated tests (unit, integration, acceptance, regression tests) as a means of early detection of errors after changes, including AI-assisted test generation (incl. its limitations),
