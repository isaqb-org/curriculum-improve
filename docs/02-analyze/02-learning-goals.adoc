...
* Problem und Lösungsansatz in einem m:n-Verhältnis einander zuordnen
* große oder komplizierte Probleme in Teilprobleme zerlegen
* Den Ursachen von Problemen systematisch auf den Grund gehen
...
* Qualitative Analyse, insbesondere Defizite bei Qualitätszielen
* Analyse der Ist-Struktur von Systemen und strukturellen Abweichungen
* Quantitative Analysemethoden (Code-Metriken, organisatorische Metriken, Laufzeitmetriken, etc.)
* Analyse von weiteren Artefakten wie Anwendungsdaten, Dokumentation, technischer Infrastruktur sowie Entwicklungs- und Betriebsprozessen
...
* Zusammenhänge zwischen externen Schnittstellen und möglichen Stakeholdern erkennen und für die Problemanalyse ausnutzen.
...
[[LZ-2-06]]
==== LZ 2-06: Erheben und Anwenden von Metriken zur quantitativen Systemanalyse

Softwarearchitekt:innen können:

* systematische quantitative Analysen durchführen, um Metriken über Systeme zu erhalten,
* geeignete Metriken auf der Grundlage von Analysezielen und verfügbaren Datenquellen auswählen und anwenden,
...
* Zuverlässigkeitsmetriken: Fehlerdichte, Fehleranzahl und Ausfallraten, mittlere Wiederherstellungszeit (MTTR), mittlere Zeit zwischen Ausfällen (MTBF)
* Laufzeitanalysen: Durchführen von dynamischen Analysen zur Bewertung des Systemverhaltens
* Entwicklungsmetriken: Entwicklungsgeschwindigkeit, Kosten pro Funktion, Kosten pro behobenem Fehler
* Organisationsmetriken: Kosten, Zeitaufwand, Teamgeschwindigkeit, Durchlaufzeiten, Zykluszeit


(Hinweis: Nicht alle Metriken müssen während der Schulungen ausführlich behandelt werden.)

[[LZ-2-07]]
==== LZ 2-07: Analysieren vorhandener Daten

Softwarearchitekt:innen können Anwendungsdaten analysieren, um datenbezogene Probleme, Datenqualitätsprobleme und entsprechende Verbesserungsmöglichkeiten zu identifizieren.

Sie kennen potenzielle Ursachen für datenbezogene Probleme, zum Beispiel:

* Datenmodelle, Schemastrukturen, Datenzugriffsmuster und Abfrageleistung
* Datenabhängigkeiten zwischen Systemen und Komponenten
* Datenqualitäten wie Vollständigkeit, Konsistenz, Genauigkeit, Aktualität, Gültigkeit und referentielle Integrität
...
* Structural analysis of systems: dependency analysis of various abstraction levels (see <<LG-2-06>>)
* Analysis of structural deviations between planned and current structures
...
* Software architects shall be able to initiate adequate documentation of problems (issues) and risks that have been identified in the course of improvement and change processes.
...
* define and document context of systems: demarcate systems with respect to their domain-related and technical neighbors, identify external interfaces.
* identify connections between external interfaces and stakeholders and use this information for problem analysis.
* elaborate problems and risks of external interfaces (e.g., with interviews, analysis of known failures, runtime analysis, protocol or log analysis, analysis of organizational relationships, analysis of quality attributes and/or service levels).
...
For this purpose, tools, including AI-assisted ones, may be used, e.g., for navigating unfamiliar codebases or extracting technical patterns and domain concepts.

(Appropriate tools may be used in the training. However, these are not a prerequisite).

[[LG-2-07]]
==== LG 2-07: Perform runtime analyses to evaluate system behavior

Software architects are able to plan and perform dynamic/runtime analysis of existing systems, e.g., with respect to runtime behavior, resource utilization, load behavior. 
